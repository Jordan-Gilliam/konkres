...
import { isLoadableComponent } from './guards';
// @ts-ignore
import logger from '../../matter/scripts/node_modules/alchemy-kit/logger';

export const errorMsg = `all async routes must have a chunkName property with value of /* webpackChunkName: "MyChunkName" */ check your routes config or use babel-plugin-after`;
