...
/** @private Guard cluase to narrow the AsyncRouteComponent union type on getInitialProps */
...
/** @private Guard cluase to narrow the AsyncRouteComponent union type on load */
