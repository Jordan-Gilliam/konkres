...
describe('matter start using webpack ' + webpackVersion, () => {
  describe('matter basic example', () => {
    ...
    it('should start a dev server', () => {
      ...
      const run = new Promise((resolve) => {
        const child = shell.exec(
          `${path.join('./node_modules/.bin/matter')} start`,
          () => {
            resolve(outputTest);
          }
        );
    ...
    it('should start a dev server on different port', () => {
      ...
      let outputTest;
      const run = new Promise((resolve) => {
        const child = shell.exec('./node_modules/.bin/matter start', () => {
          resolve(outputTest);
        });
        child.stdout.on('data', (data) => {
    ...
    it('should build and run', () => {
      let outputTest;
      shell.exec(`${path.join('./node_modules/.bin/matter')} build`);
      const run = new Promise((resolve) => {
